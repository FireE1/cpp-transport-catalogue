...
Builder::KeyBuilder BuilderInputInterface::Key(std::string str) {
  return main_.Key(std::move(str));
}

Builder &BuilderInputInterface::Value(Node::NodeVariations val) {
  return main_.Value(std::move(val));
}

Builder::DictBuilder BuilderInputInterface::StartDict() {
  return main_.StartDict();
}

Builder &BuilderInputInterface::EndDict() { return main_.EndDict(); }

Builder::ArrayBuilder BuilderInputInterface::StartArray() {
...
Builder::DictBuilder Builder::KeyBuilder::Value(Node::NodeVariations val) {
  return BuilderInputInterface::Value(std::move(val));
}

Builder::DictBuilder::DictBuilder(Builder &main)
    : BuilderInputInterface(main) {}

Builder::ArrayBuilder::ArrayBuilder(Builder &main)
    : BuilderInputInterface(main) {}

Builder::ArrayBuilder Builder::ArrayBuilder::Value(Node::NodeVariations val) {
  return BuilderInputInterface::Value(std::move(val));
}
